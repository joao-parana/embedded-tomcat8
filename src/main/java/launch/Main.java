...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    VersionLoggerListener vll = new VersionLoggerListener();
    ...
    System.out.println("tomcat 8 basedir: " + tempPath.toString());
...
class ActiveDirectoryRealm extends JNDIRealm {

  public ActiveDirectoryRealm() throws NamingException {
    super();
    String host = "10.0.0.1";
    Integer port = 636;
    connectionURL = "ldaps://" + host + ":" + port.toString();
    alternateURL = "ldap://" + host + ":" + port.toString();
    userBase = "ou=people,dc=cepel,dc=br";
    userSearch = "(cn={0})";
    userSubtree = true;
    userRoleName = "soma_role";
    connectionName = "cn=admin,ou=...,dc=cepel,dc=br";
    connectionPassword = "";
    ...
    System.out.println("containerLog = " + containerLog);

    // Ensure that we have a directory context available
    dirContext = open();
    Principal p = authenticate(dirContext, username, credentials);
